...
/* —— Hostillam home / property (homestay only — never camping/tent) —— */
...
import hostillamBedroom from '../Images/IMG_1531.JPG.jpeg'
...
/* IMG_4181.JPG shows the mural annex with campsite tarp in frame — not used for Veedu. */
...
export const images = {
  ...
  /** Hostillam Veedu hero — permanent stone home (not camping). */
  stayVeedu: hostillamStoneHouse,
  stayStoneHouse: hostillamStoneHouse,
  stayLiving: hostillamLivingRoom,
  stayGuestRoom: hostillamGuestRoom,
  stayBedroom: hostillamBedroom,
  ...
  campingValleyFire,
  /** Hostillam Experience: home garden fire-pit (not Magik campsite). */
  campfire: hostillamGardenView,
  ...
  /** No clear Hostillam food photo in uploads — do not use Magik camping food. */
  food: null,
  /** Hostillam shared living space (not Magik campsite friends). */
  community: hostillamLivingRoom,
...
export const IMAGE_PATHS = {
  ...
  stayVeedu: 'src/Images/IMG_1528.JPG.jpeg',
  stayBedroom: 'src/Images/IMG_1531.JPG.jpeg',
  ...
  campfire: 'src/Images/IMG_1526.JPG.jpeg',
  campfireNight: 'src/assets/images/uploads/camping/campfire-night.jpg',
  natureWalks: 'src/Images/IMG_4179.JPG',
  outdoorEscapes: 'src/Images/IMG_4183.JPG',
  food: null,
  community: 'src/Images/IMG_1524.JPG.jpeg',
